...
- [x] `college.db` created from `student_performance.csv`
- [x] All 8 SQL queries run without errors
- [x] 4 charts created (bar, histogram, grouped bar, pie)
- [x] Student Performance Dashboard (2×2 grid) complete
- [x] Notebook saved as `Day_02_Database_SQL_Visualization.ipynb`
- [x] Notebook uploaded to GitHub
- [x] Commit message: `feat: add Day 2 notebook and student performance dashboard`
