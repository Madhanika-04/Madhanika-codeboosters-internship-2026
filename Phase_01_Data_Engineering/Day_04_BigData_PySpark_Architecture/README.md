...
- [x] `spark.version` printed successfully (Cell 2)
- [x] `df_bronze.count()` returns 5000
- [x] `sales_bronze.parquet` saved
- [x] `sales_silver.parquet` saved with new columns
- [x] At least one Gold Parquet table saved
- [x] `big_data_dashboard.png` visible in output
- [x] Notebook uploaded to GitHub
- [x] Commit: `Add Day 4: Big Data PySpark Medallion Pipeline`
