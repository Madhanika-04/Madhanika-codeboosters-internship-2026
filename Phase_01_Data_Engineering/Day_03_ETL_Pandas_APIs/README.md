...
- [x] `df.isnull().sum().sum() == 0` after cleaning sales data
- [x] `df.duplicated().sum() == 0` after deduplication
- [x] `weather_data.csv` saved (8 cities)
- [x] `clean_sales_data.csv` saved
- [x] Weather dashboard (3-panel chart) visible
- [x] Upload: `Add Day 3: ETL Pipeline + Weather API`
