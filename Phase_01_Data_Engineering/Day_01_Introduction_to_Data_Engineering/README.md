...
5. Name: `madhanika-codeboosters-internship-2026`
6. Set to **Public**
...
- [x] I can explain what a Data Engineer does
- [x] I can classify Structured, Semi-Structured, and Unstructured data
- [x] I have loaded `student_performance.csv` in Google Colab
- [x] All notebook cells run without errors
- [x] I have created a GitHub account
- [x] I have created a repository named `Madhanika-codeboosters-internship-2026`
- [x] I have uploaded my Day 1 notebook to GitHub
