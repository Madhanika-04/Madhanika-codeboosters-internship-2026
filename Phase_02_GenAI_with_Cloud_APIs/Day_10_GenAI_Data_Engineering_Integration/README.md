...
- [x] Capstone notebook runs from top to bottom without errors
- [x] At least one successful Groq API call completed
- [x] Data loaded from CSV and analyzed with Pandas or SQL
- [x] AI response is displayed and readable
- [x] Output saved to a file (`.txt` or `.csv`)
- [x] Code has markdown cells explaining each major section
- [x] Responsible AI guardrail added to at least one prompt
- [x] Capstone showcased to the class
- [x] All 10 day notebooks saved locally or to Google Drive
- [x] Career roadmap action plan noted
