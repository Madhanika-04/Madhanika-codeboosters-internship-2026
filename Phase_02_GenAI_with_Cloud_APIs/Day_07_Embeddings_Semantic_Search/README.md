...
- [x] Ran all notebook cells from top to bottom without errors
- [x] Observed keyword search missing relevant results (cells 007–008)
- [x] Generated embeddings and checked shape is (N, 384) (cells 010–012)
- [x] Calculated cosine similarity — similar pair > 0.6, different pair < 0.3 (cell 013)
- [x] Created ChromaDB collection and added documents (cells 017–018)
- [x] Queried by meaning and interpreted distance scores (cells 019–022)
- [x] Completed mini project: indexed 15 notes, ran 5 queries, used where= filter (cells 030–041)
- [x] Pushed notebook to GitHub repo `codeboosters-internship-2024`
