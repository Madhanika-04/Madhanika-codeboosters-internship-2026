...
- [x] CSV loaded into SQLite: `len(df) == 30`
- [x] Schema printed with all 8 columns visible
- [x] SQL generated correctly for at least one test question
- [x] execute_sql returns a DataFrame with correct rows
- [x] Bar chart renders for a query with numeric results
- [x] Natural language answer mentions actual names and numbers from data
- [x] Dashboard tested with at least 3 different question types
- [x] Database connection closed at end: `conn.close()`
