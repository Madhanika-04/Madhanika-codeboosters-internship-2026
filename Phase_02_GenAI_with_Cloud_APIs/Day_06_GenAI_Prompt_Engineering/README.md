...
- [x] First API call successful (Cell 3)
- [x] Weak vs strong prompt comparison done (Cell 9)
- [x] All 5 invoices processed (Cell 12)
- [x] `cleaned_invoices.csv` saved
- [x] Notebook uploaded to GitHub
- [x] Commit: `Add Day 6: GenAI Prompt Engineering + Smart Data Cleaner`
